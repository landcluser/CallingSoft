...
<head>
    ...
    <meta name="application-name" content="YouthfireIT Messenger">
    <meta name="apple-mobile-web-app-title" content="YouthfireIT Messenger">
    ...
    @yield('seo')
    <title>Calling | @yield('title', 'YouthfireIT Messenger')</title>
