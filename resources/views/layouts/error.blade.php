...
<head>
    ...
    <meta name="title" content="@yield('title', 'YouthfireIT Messenger - Alert')">
    @yield('seo')
    <title>@yield('title', 'YouthfireIT Messenger - Alert')</title>
...
<wrapper class="d-flex flex-column">
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
        <a class="navbar-brand" href="/">
            <img src="{{ asset('images/tipz.png') }}" width="30" height="30" class="d-inline-block align-top" alt="YouthFireIT">
